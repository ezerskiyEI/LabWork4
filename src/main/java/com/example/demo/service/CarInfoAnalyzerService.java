...
public class CarInfoAnalyzerService {
    ...
    private static final Pattern MAKE_MODEL_PATTERN = Pattern.compile(
            "(mercedes-benz|bmw|honda|ford|audi|renault|toyota|nissan|hyundai|volkswagen|chevrolet|kia|mazda|subaru|volvo|mitsubishi|infiniti|\" +\n" +
                    "\"jaguar|land-rover|lexus|acura|porsche|ferrari|lamborghini|bentley|rolls-royce|bugatti|alfa-romeo|fiat|peugeot|citroen|suzuki|isuzu|\" +\n" +
                    "\"seat|skoda|saab|dodge|chrysler|jeep|ram|lincoln|buick|gmc|cadillac|pontiac|oldsmobile|saturn|hummer|scion) ([\\w-]+)",
